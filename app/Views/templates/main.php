...
<head>
    ...
    <title>
        <?php echo $this->renderSection('titlePage') ?>
    </title>
          ...
          if ($session->tipo == 'Admin') { ?>
                    ...
                    <li class="nav-item">
                        <a href="<?= base_url('employee') ?>" class="nav-link">
                            <i class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <?php } elseif ($session->tipo == 'Empleado') { ?>
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>
                                <?= $this->renderSection('tituloContent') ?>
                            </h1>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <?= $this->renderSection('subTitlecontent') ?>
                        </h3>
